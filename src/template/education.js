...
export default (props) => {
    ...
    return(
        <div >
            <header className=" text-center py-12 border-purple-500 border-solid border-t-8">
                        ...
                        <li className="bg-white shadow mt-4 flex" key={index}>
                            ...
                            <div className="flex items-center flex-1 p-8">
                               <div className="flex-1">
                                    ...
                                    {
                                        item.degree && <span className="inline-block p-2 radius bg-purple-100 text-pink-700">{item.degree}</span>
                                    }
                                    {
                                        item.url && <a className="btn mt-4 inline-block" target="_blank" rel="noopener noreferrer" href={item.url}>Ver mas</a>
                                    }
                               </div>
                            </div>
                        </li>
